...
public class PopulationForward extends Neuron {
    ...
    public PopulationForward(Creature creature) {
        super(creature, "population_forward_external");
    }
    ...
    public double value() {
        ...
        if (hlen < 0.0001) return 0.0; // no heading -> treat as empty
