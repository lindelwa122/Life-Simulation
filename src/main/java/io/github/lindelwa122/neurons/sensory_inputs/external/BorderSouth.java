...
public class BorderSouth extends Neuron {
    public BorderSouth(Creature creature) {
        super(creature, "border_south_external");
    }
    ...
    public double value() {
        ...
        double normalized = (double) yTile / (double) maxYTile;
