...
public class PopulationEast extends Neuron {
    ...
    public PopulationEast(Creature creature) {
        super(creature, "population_east_external");
    }
    ...
    public double value() {
        ...
        for (Creature other : world.getCreaturesList()) {
            ...
            // East sector: other is to the right and more horizontal than vertical
