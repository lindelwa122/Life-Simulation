...
public class PheromoneSouth extends Neuron {
    ...
    public PheromoneSouth(Creature creature) {
        super(creature, "pheromone_south_external");
    }
